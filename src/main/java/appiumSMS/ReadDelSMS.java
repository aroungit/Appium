...
public class ReadDelSMS {
	...
	public static void ReadSMS() throws Exception, URISyntaxException {
		...
		driver.findElement(AppiumBy.id("com.samsung.android.messaging:id/recipients_editor_to"))
				.sendKeys("+91-9444047658");
		driver.findElement(AppiumBy.xpath(
				"//android.view.ViewGroup[@resource-id=\"com.samsung.android.messaging:id/bubble_list_view\"]/android.widget.LinearLayout"))
				.click();
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(AppiumBy.xpath(
				"(//android.widget.LinearLayout[@resource-id=\"com.samsung.android.messaging:id/card_view_list_item\"])[1]/android.widget.LinearLayout"))
				.click();
		// WebElement lp =
		// driver.findElement(AppiumBy.xpath("(//android.widget.TextView[@resource-id=\"com.samsung.android.messaging:id/content_text_view\"])[11]"));
		...
		driver.findElement(
				AppiumBy.xpath("//android.widget.TextView[@resource-id=\"android:id/title\" and @text=\"Delete\"]"))
				.click();
	...
	public static void longpress(WebElement ele) {
		...
		sequence.addAction(
				input.createPointerMove(Duration.ofSeconds(5), PointerInput.Origin.viewport(), location.x, location.y));
